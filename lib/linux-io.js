...
var pinModes = [
  { modes: [0, 1],    gpioNo: 247       },  // Wiring PI => 0  | ODROID => 247
  { modes: [0, 1],    gpioNo: 238       },  // Wiring PI => 1  | ODROID => 238
  { modes: [0, 1],    gpioNo: 239       },  // Wiring PI => 2  | ODROID => 239
  { modes: [0, 1],    gpioNo: 237       },  // Wiring PI => 3  | ODROID => 237
  { modes: [0, 1],    gpioNo: 236       },  // Wiring PI => 4  | ODROID => 236
  { modes: [0, 1],    gpioNo: 233       },  // Wiring PI => 5  | ODROID => 233
  { modes: [0, 1],    gpioNo: 231       },  // Wiring PI => 6  | ODROID => 231
  { modes: [0, 1],    gpioNo: 249       },  // Wiring PI => 7  | ODROID => 249
  { modes: []                           },  // Wiring PI => 8  | ODROID => null
  { modes: []                           },  // Wiring PI => 9  | ODROID => null
  { modes: [0, 1],    gpioNo: 229       },  // Wiring PI => 10 | ODROID => 229
  { modes: [0, 1],    gpioNo: 225       },  // Wiring PI => 11 | ODROID => 225
  { modes: [0, 1],    gpioNo: 235       },  // Wiring PI => 12 | ODROID => 235
  { modes: [0, 1],    gpioNo: 232       },  // Wiring PI => 13 | ODROID => 232
  { modes: [0, 1],    gpioNo: 230       },  // Wiring PI => 14 | ODROID => 230
  { modes: [2],       analogChannel: 0  },  // Wiring PI => 15 | ODROID => A0
  { modes: [2],       analogChannel: 1  },  // Wiring PI => 16 | ODROID => A1
  { modes: [],                          },  // Wiring PI => 17 | ODROID => null
  { modes: [],                          },  // Wiring PI => 18 | ODROID => null
  { modes: [],                          },  // Wiring PI => 19 | ODROID => null
  { modes: [],                          },  // Wiring PI => 20 | ODROID => null
  { modes: [0, 1],    gpioNo: 228       },  // Wiring PI => 21 | ODROID => 228
  { modes: [0, 1],    gpioNo: 219       },  // Wiring PI => 22 | ODROID => 219
  { modes: [0, 1],    gpioNo: 234       },  // Wiring PI => 23 | ODROID => 234
  { modes: [0, 1],    gpioNo: 214       },  // Wiring PI => 24 | ODROID => 214
  { modes: []                           },  // Wiring PI => 25 | ODROID => null
  { modes: [0, 1],    gpioNo: 224       },  // Wiring PI => 26 | ODROID => 224
  { modes: [0, 1],    gpioNo: 218       },  // Wiring PI => 27 | ODROID => 218
];
...
OdroidIO.prototype._analogRead = function(pinData, callback) {
  AnalogReader(pinData.analogChannel, callback);
};
